...
public class MyAccountsPage extends Utility {
    ...
    public void enterFirstName() {
        sendTextToElement(firstName, "Gaurav");
    }
    ...
    public void enterEMail() {
        ...
        String emailID = "gaurav" + userName + "@gmail.com";
        sendTextToElement(this.emailId, emailID);
    }

    public void enterPhoneNumber() {
        sendTextToElement(mobileNumber, "07525400007");
    }

    public void enterPassword() {
        sendTextToElement(password, "GK12123");
    }

    public void enterConfirmPassword() {
        sendTextToElement(confirmPassword, "GK12123");
    }
    ...
    public void enterEmail() {
        sendTextToElement(emailId, "GK12123@gmail.com");
    }
