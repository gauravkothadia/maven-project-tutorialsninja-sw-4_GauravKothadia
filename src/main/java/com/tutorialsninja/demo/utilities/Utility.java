...
//*************************** Action Methods ***************************************//
    ...
    public List<String> afterFilterProductNames(By by) {
        ...
        List<WebElement> afterFilterProductNames = findMultipleElements(by);
    ...
    public List<Double> convertPriceListToReverse(By by) {
        List<WebElement> beforeFilterProductPrice = findMultipleElements(by);
        //Create arraylist
    ...
    public List<Double> afterFilterPrice(By by) {
        //Store elements after filtering
        List<WebElement> afterFilterProductPrice = findMultipleElements(by);
